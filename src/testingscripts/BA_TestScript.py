...
ROI = (172, 1015, 240, 65)  # (x, y, w, h) adjust to where numbers appear
...
def process_video(file_path):
    ...
    def extract_info_from_frame(frame, executor, roi=None):
        ...
        return [resNum, cont_active, ror_active]
...
if __name__ == "__main__":
    ...
    video_file = r"C:\Users\Lucas\Desktop\Culvert-Analyser\tests\testvideos\BA_Test_Vid.mp4"
    ...
    for i in range(len(series1)):
        ...
        data.append({
            "time": i,
            "score": int(series1[i][0]),
            "cont_active": series1[i][1],
            "ror_active": series1[i][2]
        })
    ...
    # Plot
    plt.bar(df["time"], df["score"], label="Video 1")
